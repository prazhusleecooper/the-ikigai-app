    ...
    const handleProceed = async () => {
        ...
        if(values.length === 0) {
            ...
            if(response?.data?.status === true) {
                ...
                navigate('/what-you-can-be-paid-for');
    ...
    return(
        <div className='value-form-wrapper'>
            ...
            <p className='prompt-text'>
                Write all the stuff that you think the world needs
                <br />
...
export default WhatTheWorldNeeds;