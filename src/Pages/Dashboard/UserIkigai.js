...
const UserIkigai = () => {
    ...
    // ? STATE
    const [whatYouLove, setWhatYouLove] = useState(state.whatYouLove);
    const [whatYouLoveInput, setWhatYouLoveInput] = useState('');

    const [whatTheWorldNeeds, setWhatTheWorldNeeds] = useState(state.whatTheWorldNeeds);
    const [whatTheWorldNeedsInput, setWhatTheWorldNeedsInput] = useState('');

    const [whatYouCanBePaidFor, setWhatYouCanBePaidFor] = useState(state.whatYouCanBePaidFor);
    const [whatYouCanBePaidForInput, setWhatYouCanBePaidForInput] = useState('');

    const [whatYouAreGoodAt, setWhatYouAreGoodAt] = useState(state.whatYouAreGoodAt);
    ...
    return(
        <div className='dashboard-wrapper'>
            ...
            <div className='ikigai-section' style={{pointerEvents: 'none'}}>
                <DragDropContext
                    onDragEnd={ onDragEnd }
                >
                    <Droppable
                    ...
                    >
                        {
                            (provided) => (
                                <div
                                    ...
                                    ref={provided.innerRef}
                                >
                                    <span className='section-heading'>What they Love</span>
                                    {/* <form
                    ...
                    >
                        {
                            (provided) => (
                                <div
                                    ...
                                    ref={provided.innerRef}
                                >
                                    <span className='section-heading'>What they can be Paid for</span>
                    ...
                    >
                        {
                            (provided) => (
                                <div
                                    ...
                                    ref={provided.innerRef}
                                >
                                    <span className='section-heading'>What they are Good at</span>
                                    {/* <form
                                        className='input-form'
